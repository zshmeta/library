  ...
  return (
    <StyledMain key={mode} mode={mode}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center', padding: '20px' }}>
        <Slider placeholder="Default" mode={mode} />
        <Slider placeholder="Invalid Entry" invalid={true} mode={mode} />
        <Slider placeholder="Valid Entry" valid={true} mode={mode} />
        <Slider placeholder="Disabled" disabled={true} mode={mode} />
      </div>
    </StyledMain>
  );
};
