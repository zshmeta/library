  ...
  return (
    <StyledMain key={mode} mode={mode}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center', padding: '20px' }}>
        <Snackbar placeholder="Default" mode={mode} />
        <Snackbar placeholder="Invalid Entry" invalid={true} mode={mode} />
        <Snackbar placeholder="Valid Entry" valid={true} mode={mode} />
        <Snackbar placeholder="Disabled" disabled={true} mode={mode} />
      </div>
    </StyledMain>
  );
};
