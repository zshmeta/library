  ...
  return (
    <StyledMain key={mode} mode={mode}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center', padding: '20px' }}>
        <Tabs placeholder="Default" mode={mode} />
        <Tabs placeholder="Invalid Entry" invalid={true} mode={mode} />
        <Tabs placeholder="Valid Entry" valid={true} mode={mode} />
        <Tabs placeholder="Disabled" disabled={true} mode={mode} />
      </div>
    </StyledMain>
  );
};
