  ...
  return (
    <StyledMain key={mode} mode={mode}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center', padding: '20px' }}>
        <List placeholder="Default" mode={mode} />
        <List placeholder="Invalid Entry" invalid={true} mode={mode} />
        <List placeholder="Valid Entry" valid={true} mode={mode} />
        <List placeholder="Disabled" disabled={true} mode={mode} />
      </div>
    </StyledMain>
  );
};
