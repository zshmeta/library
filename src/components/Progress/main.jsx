  ...
  return (
    <StyledMain key={mode} mode={mode}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center', padding: '20px' }}>
        <Progress placeholder="Default" mode={mode} />
        <Progress placeholder="Invalid Entry" invalid={true} mode={mode} />
        <Progress placeholder="Valid Entry" valid={true} mode={mode} />
        <Progress placeholder="Disabled" disabled={true} mode={mode} />
      </div>
    </StyledMain>
  );
};
